...
<section class="about">
   ...
   <div class="row">
      ...
      <div class="content">
         ...
         <a href="menu.l" class="btn">our menu</a>
      </div>
   ...
   <div class="swiper reviews-slider">
      ...
      <div class="swiper-wrapper">
         ...
         <div class="swiper-slide slide">
            ...
            <p>"The food here is amazing! I've never had a bad meal. The staff is friendly and the service is quick. Highly recommend!"</p>
            <div class="stars">
         ...
         <div class="swiper-slide slide">
            ...
            <p>"I've been a regular customer for years. The food is consistently delicious and the service is always top-notch. Love this place!"</p>
            <div class="stars">
               <i class="fas fa-star"></i>
               <i class="fas fa-star"></i>
               <i class="fas fa-star"></i>
         ...
         <div class="swiper-slide slide">
            ...
            <p>"The best restaurant in town! The food is always fresh and delicious. The staff is friendly and the atmosphere is cozy. Highly recommend!"</p>
            <div class="stars">
               <i class="fas fa-star"></i>
               <i class="fas fa-star"></i>
               <i class="fas fa-star"></i>
