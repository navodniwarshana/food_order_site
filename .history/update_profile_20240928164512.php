...
if(isset($_POST['submit'])){
   ...
   if(isset($_FILES[''])){
      ...
      $file_ext = strtolower(end(explode('.',$_FILES['']['name'])));
...
<section class="form-container update-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="file" name="" accept="image/*" style="color: #000; background: #fff; border: 1px solid #ccc; padding: 10px; border-radius: 5px;">
