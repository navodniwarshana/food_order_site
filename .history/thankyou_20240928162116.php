...
if(isset($_POST['submit'])){
   ...
   // Corrected the number of placeholders and values
   $insert_review = $conn->prepare("INSERT INTO `reviews`(user_id, customer_name, review_text, rating, created_at) VALUES(?,?,?,?,?)");
   $insert_review->execute([$user_id, $customer_name, $review_text, $rating, $created_at]); // Ensure all values are provided
