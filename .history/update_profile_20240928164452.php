...
if(isset($_POST['submit'])){
   ...
   if(isset($_FILES['profile_picture'])){
      ...
      if(empty($message)==true){
         ...
         $update_picture = $conn->prepare("UPDATE `users` SET user = ? WHERE id = ?");
...
<section class="form-container update-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="file" name="profile_picture" accept="image/*" style="color: #000; background: #fff; border: 1px solid #ccc; padding: 10px; border-radius: 5px;">
