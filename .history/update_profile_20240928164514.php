...
if(isset($_POST['submit'])){
   ...
   if(isset($_FILES['user_'])){
      $file_name = $_FILES['user_']['name'];
      $file_size = $_FILES['user_']['size'];
      $file_tmp = $_FILES['user_']['tmp_name'];
      $file_type = $_FILES['user_']['type'];
      $file_ext = strtolower(end(explode('.',$_FILES['user_']['name'])));
...
<section class="form-container update-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="file" name="user_" accept="image/*" style="color: #000; background: #fff; border: 1px solid #ccc; padding: 10px; border-radius: 5px;">
