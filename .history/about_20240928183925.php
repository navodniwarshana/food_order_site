   ...
   <section class="reviews">
      ...
      <div class="swiper reviews-slider">
         <div class="swiper-wrapper">
            ...
            <?php
            // Fetch unique reviews using DISTINCT
            $select_reviews = $conn->prepare("SELECT DISTINCT r.id, r.review_text, r.rating, u.name, u.user_image 
                                              FROM `reviews` r 
                                              JOIN `users` u 
                                              ON r.user_id = u.id");
            ...
            if (count($reviews) > 0) {
               // Loop through all the unique reviews
