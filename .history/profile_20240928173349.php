...
<body>
   ...
   <section class="user-details">
      ...
      <div class="user">
         ...
         <div class="profile-picture" style="display: flex; align-items: center; justify-content: center; flex-direction: column; padding: rem;  margin: rem;  box-shadow: 0 0 10px rgba(0, 0, 0, 0.1); margin-bottom: 1rem;">
