...
<body>
   ...
   <section class="user-details">
      ...
      <div class="user">
         ...
         <div class="profile-picture" style="border-radius: 50%; border: 1px solid black;">
            <img src="<?php echo $user_image; ?>" alt="" style="border-radius: 50%; width: 100%; height: 100%; object-fit: cover;">
         </div>
