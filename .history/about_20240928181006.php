...
<section class="reviews">
   ...
   <div class="swiper reviews-slider">
      ...
      <div class="swiper-wrapper">
         ...
         <?php
         $select_reviews = $conn->prepare("SELECT r.id, r.customer_name, r.review_text, r.rating, u.user_name, u.user_image FROM `reviews` r JOIN `users` u ON r.customer_id = u.id");
